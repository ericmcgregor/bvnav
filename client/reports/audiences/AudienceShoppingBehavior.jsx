...
AudienceShoppingBehavior = class AudienceShoppingBehavior extends React.Component{
  render(){
    return(
                ...
                <ChartContainer title="Brand: Share of voice">
                  <table className="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>Site</th>
                        <th className="text-xs-center">Pageviews</th>
                      </tr>
                    </thead>
                    <tbody>
                        {
                          Object.keys(this.props.shareOfVoiceByNumberOfPeople).map((key, index)=>{
                            return (
                              <tr key={index}>
                                <td>{key}</td>
                                <td className="text-xs-center">{this.props.shareOfVoiceByNumberOfPeople[key]}</td>
                              </tr>
                            )
                          })
                        }
                    ...
                    <tbody>
                        {
                          Object.keys(this.props.topTier1InterestsByPeople).map((key, index)=>{
                            return (
                              <tr key={index}>
                                <td>{key}</td>
                                <td className="text-xs-center">{this.props.topTier1InterestsByPeople[key]}</td>
                              </tr>
                            )
                          })
                        }
                    ...
                    <tbody>
                        {
                          Object.keys(this.props.topTier2InterestsByPeople).map((key, index)=>{
                            return (
                              <tr key={index}>
                                <td>{key}</td>
                                <td className="text-xs-center">{this.props.topTier2InterestsByPeople[key]}</td>
                              </tr>
                            )
                          })
                        }
