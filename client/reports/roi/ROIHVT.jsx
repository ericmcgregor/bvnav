...
ROIHVTreport = class ROIHVTreport extends React.Component{
  componentDidMount(){
  }
  componentDidUpdate(){
  }
    ...
    return (
      <div>
        ...
        <div className="card report-card">
          <ReportCardHeader title="High Value Tasks" />


          <table className="table table-bordered table-text-center m-a-0">
            <thead hidden>
              <tr>
                <th>Task</th>
...
ROIHVTreportClass = createContainer(({ params }) => {
...
ROIHVTfrequencyClass = createContainer(({ params }) => {
  let Data = Session.get('ROIdata');
  getROIdata(Session.get('ROIid'), roas=4.21, spend=125000, conversions=451);
  if(!Data) {
    console.log('no data', Data)
